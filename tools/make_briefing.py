...
# THE SPLIT IS GONE (2026-09-09). Page 5 shipped as two chunks in two
# banks from no-load step 6 until bank 6 had room for it whole again: the
# SCANSTEP unfold that took bank 6 down to 294 has been paid for several
# times over since (drYcol into zero page alone gave it 420), and the
# whole page is 313 packed against the 329 the two chunks cost. What went
# with it: split_page() and its cut-search cache, BR_SPLIT_PAGE/_PAGES,
# main.asm's BR_SPLIT_SLOT and BrDepackChain, brstream4b.asm, and the
# "exactly one page may split" rule that came with the compare.
# docs/no-load.md 21.
