...
\ CalcAxis and CalcSpeed moved to droid.asm — BANK 4. Called only
\ from the main loop at the resting state; main RAM below &3000 ran
\ out when Layer 10's trampolines arrived.
