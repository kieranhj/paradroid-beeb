...
| `&1100–&2E6C` | 7,533 B | code (`PARA`). DFS random-access buffer space, safe for `*LOAD` |
| `&2E6D–&2FFF` | **403 B free** | **tight again** — 7e and 7f still to come. See the note in `docs/layer-7-combat.md` under 7d |
