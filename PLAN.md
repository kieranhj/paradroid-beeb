...
| **Sound** | Layer 11e stages 0–4 **BUILT AND TUNED 2026-08-21**: driver in bank 4, every in-game trigger wired, and ten by-ear rounds with KC signed off the hum, explosions, bump, disruptor, ram-kill, bullet-hit, lift and start. **Open**: the game-over set (KC: "needs work, leave for now"), the transfer-verdict mapping (unverified guess), fx06 with 11d — plus pause/volume keys, still deferred. The chatter landed with 11f (it is the *briefing's* sound, not the title's). **Bank 4: 4 bytes free.** [`docs/layer-11e-sound.md`](docs/layer-11e-sound.md) | game-over set + odds and ends |
