...
*Diagnostic worth keeping:* a debug key (**CTRL+R**, under `DEBUG_REDRAW`; plain R and no flag
until 2026-08-31, SPACE until 2026-08-26) forces `RedrawAll`, so the incremental buffer can be
