...
| Bank 5 | **1,421 B** (2026-09-08: **+756** from SCANSTEP tail folding, 70 compiled rows ending `JMP <tail>` rather than an inline `SCANSTEP` + `RTS`; `docs/no-load.md` §11j. It was 665 on the gauge before it) (2026-09-01: **+668** from the SCANSTEP deferred carry, 168 expansions at 4 B apiece; it was **6 B** immediately before that, the tightest region in the machine) |
| Bank 6 | **1,308 B** (2026-09-08: **+756**, the same tail folding as bank 5) (2026-09-06: —112 for layer-12 DECISION 6's character filter, the cleared-deck stipple fix; 664 on the gauge before it) (2026-09-02: —75 for layer-9 DECISION 20's `PnEnergy`, and before it —183 for layer-12 DECISION 6 — `LvClearedMark`, the 64 B of `svdecks6.asm` and its scratch; 931 B before). **The bank with room, and the reason DECISION 6 could be built at all** |
...
tail folding (**SPENT 2026-09-08, +756 a bank — not the ~1,050 estimated**), `door.asm` to bank 4, the `hsfont` dedup (SPENT 2026-09-07, no-load step 3).
